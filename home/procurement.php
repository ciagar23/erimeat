<div class="m-b-30" style="position:relative;">
  ...
  <div class="homepage-top-text text-center m-t-50 container-fluid">
    <h2 class="text-white">Procurement</h2>
  </div>
</div>
<div class="container-fluid m-b-30">
  ...
  <div class="center-page container-80">
    ...
    <h3 class="text-center m-b-30">Simplify your search for top procurement talent</h3>
    <p class="text-center m-b-30" style="font-size: 17px;">
      Involves the process of selecting vendors, establishing payment terms, strategic vetting,
      selection, the negotiation of contracts and actual purchasing of goods. We are concerned
      with acquiring (procuring) all of the goods, services, and work that is vital to an organization.
