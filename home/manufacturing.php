...
<div class="container-fluid m-b-30">
  ...
  <div class="center-page container-80">
    ...
    <h3 class="text-center m-b-30">Simplify your search for top manufacturer talent</h3>
    <p class="text-center m-b-30" style="font-size: 17px;">
      We cover work performed in mechanical, physical, or components into new products. Assembling of
      component parts for manufactured products also falls under this umbrella unless the activity is
      appropriately classified in Construction.
    </p>
